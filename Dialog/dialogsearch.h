...
public:
    enum {FIELD_ID = 0, FIELD_CRUISE_NUMBER, FIELD_DIVE_NUMBER, FIELD_SCAN_LINE, FIELD_CRUISE_YEAR, FIELD_DT_TIME,
          ...
          FIELD_HEIGHT_FROM_BOTTOM, FIELD_R_THETA, FIELD_SIDE_SCAN_IMAGE_NAME, FIELD_ALONG_TRACK, FIELD_ACROSS_TRACK,
          FIELD_REMARKS, FIELD_SUPPOSE_SIZE, FIELD_PRIORITY, FIELD_VERIFY_AUV_SSS_IMAGE_PATHS, FIELD_VERIFY_IMAGE_PATHS,
          FIELD_IMAGE_DESCRIPTION, FIELD_TARGET_LONGITUDE, FIELD_TARGET_LATITUDE, FIELD_POSITION_ERROR, FIELD_VERIFY_CRUISE_NUMBER,
          FIELD_VERIFY_DIVE_NUMBER, FIELD_VERIFY_TIME, FIELD_STATUS };
