...
class DialogUploadData : public QDialog
{
    ...
    enum { CELL_ID = 2, CELL_COMPUTER_TIME, CELL_DT_TIME, CELL_LONGITUDE, CELL_LATITUDE, CELL_DT_SPEED, CELL_HORIZONTAL_RANGE_DIRECTION, CELL_HORIZONTAL_RANGE_VALUE,
           CELL_HEIGHT_FROM_BOTTOM, CELL_T_THEAT, CELL_SIDE_SCAN_IMAGE_NAME, CELL_ALONG_TRACK, CELL_ACROSS_TRACK, CELL_REMARKS, CELL_SUPPOSE_SIZE, CELL_PRIORITY,
           CELL_VERIFY_IMAGE_PATHS, CELL_IMAGE_DESCRIPTION, CELL_TARGET_LONGITUDE,CELL_TARGET_LATITUDE, CELL_POSITION_ERROR, CELL_CRUISE_NUMBER, CELL_DIVE_NUMBER, CELL_STATUS };
public:
